...
contract MultiSigWallet {
    ...
    function addOwner(address newOwner) isOwner public validOwner() {
      //YOUR CODE HERE
      // _owners[newOwner] = 1;
    }

    /// @dev remove suspicious owners
    function removeOwner(address existingOwner) isOwner public validOwner() {
      //YOUR CODE HERE
      //Cannot delete himself, ensures at least one owner
      // require((msg.sender) != existingOwner);
